...
urlpatterns = [
    ...
    url(r'^historico$', login_required(views.SolicitarHistorico.as_view()), name='solicitar_historico'),
    ...
    # url(r'^deletar$', login_required(views.SolicitacaoDelete.as_view()), name='solicitar_deletar'),
